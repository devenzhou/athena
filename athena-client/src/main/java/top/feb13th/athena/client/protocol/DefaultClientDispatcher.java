...
import top.feb13th.athena.client.bean.ClientModuleBeanHolder;
import top.feb13th.athena.client.bean.ClientModuleBeanWrapper;
import top.feb13th.athena.client.support.ClientRequest;
...
public class DefaultClientDispatcher extends MessageToMessageDecoder<Response> {
  ...
  protected void decode(ChannelHandlerContext ctx, Response msg, List<Object> out)
    ...
    ClientModuleBeanWrapper wrapper = ClientModuleBeanHolder.get(module, command);
    if (wrapper == null) {
      // 资源找不到
   ...
   * @param response 请求对象
   */
  private void invokeMethod(ClientModuleBeanWrapper wrapper, Response response)
